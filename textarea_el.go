...
func (t *TextareaEl) Required() *TextareaEl            { t.Element.Attr("required", ""); return t }
...
// Factory: (name, placeholder) — default rows=3 is HTML default, no need to set explicitly
